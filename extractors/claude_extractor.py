...
Uses OpenRouter (https://openrouter.ai) as the gateway to reach Anthropic's
Claude Haiku 4.5 - same OPENROUTER_API_KEY as gpt_extractor.py, no separate
Anthropic account/billing needed. Check https://openrouter.ai/models for
current pricing on this model before trusting compare.py's cost numbers -
